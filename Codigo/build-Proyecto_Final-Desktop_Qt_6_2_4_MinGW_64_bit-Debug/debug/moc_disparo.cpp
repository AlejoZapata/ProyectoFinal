...
#include <memory>
#include "../../Proyecto_Final/disparo.h"
...
QT_MOC_LITERAL(8, 12), // "MatarJugador"
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 12) // "applyGravity"

    },
    "Disparo\0MatarJugador\0\0applyGravity"
};
...
void Disparo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->MatarJugador(); break;
        case 1: _t->applyGravity(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Disparo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Disparo::MatarJugador)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Disparo, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
